# RoboCop 2's google.py - A backport of the Google module from classic RoboCop, using urllib instead of requests
...
def api_get(kind, query):
    ...
    url = 'https://ajax.googleapis.com/ajax/services/search/%s?' \
          'v=1.0&safe=moderate'

...
"""This plugin is really messy I promise I will clean it up later."""
...
def nflScores(text=" "):
    ...
    response = http.get_html(
        'http://scores.espn.go.com/nfl/bottomline/scores', decode=False)
    game = ""
...
def mlbScores(text=" "):
    ...
    response = http.get_html(
        'http://scores.espn.go.com/mlb/bottomline/scores', decode=False)
    game = ""
    score = response.text_content()
    raw = score.replace('%20', ' ')
    raw = raw.replace('^', '')
...
def nbaScores(text=" "):
    ...
    response = http.get_html(
        'http://scores.espn.go.com/nba/bottomline/scores', decode=False)
    game = ""
    score = response.text_content()
    raw = score.replace('%20', ' ')
    raw = raw.replace('^', '')
...
def ncaabScores(text=" "):
    ...
    response = http.get_html(
        'http://scores.espn.go.com/ncb/bottomline/scores', decode=False)
    game = ""
    score = response.text_content()
    raw = score.replace('%20', ' ')
    raw = raw.replace('^', '')
...
def ncaafScores(text=" "):
    ...
    response = http.get_html(
        'http://scores.espn.go.com/ncf/bottomline/scores', decode=False)
    game = ""
    score = response.text_content()
    raw = score.replace('%20', ' ')
    raw = raw.replace('^', '')
...
def nhlScores(text=" "):
    ...
    response = http.get_html(
        'http://scores.espn.go.com/nhl/bottomline/scores', decode=False)
    game = ""
    score = response.text_content()
    raw = score.replace('%20', ' ')
    raw = raw.replace('^', '')
...
def wnbaScores(text=" "):
    ...
    response = http.get_html(
        'http://scores.espn.go.com/wnba/bottomline/scores', decode=False)
    game = ""
    score = response.text_content()
    raw = score.replace('%20', ' ')
    raw = raw.replace('^', '')
